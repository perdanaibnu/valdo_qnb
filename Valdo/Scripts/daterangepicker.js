...
(function (root, factory) {
            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini form-control datemask2" type="text" name="daterangepicker_start" value="" />' +
                ...
                '<div class="calendar right">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini form-control datemask2" type="text" name="daterangepicker_end" value="" />' +
                      '<i class="fa fa-calendar glyphicon glyphicon-calendar"></i>' +
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="fa fa-clock-o glyphicon glyphicon-time"></i>' +
    ...
    DateRangePicker.prototype = {
        ...
        formInputsFocused: function(e) {
            ...
            $(e.target).addClass('active').inputmask('mm/dd/yyyy', { 'placeholder': 'mm/dd/yyyy' });
